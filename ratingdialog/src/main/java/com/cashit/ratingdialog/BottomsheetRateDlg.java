package com.cashit.ratingdialog;
...
import com.cashit.ratingdialog.model.DlgButton;


/**
 * Creates BottomSheet Material Dialog with 2 buttons.
 * <p>
 * Use {@link BottomsheetRateDlg.Builder} to create a new instance.
 */
public class BottomsheetRateDlg extends AbstractDlg {

    private AppCompatActivity mActivity;

    protected BottomsheetRateDlg(@NonNull final AppCompatActivity mActivity,
                                 @NonNull String title,
                                 @NonNull String message,
                                 boolean mCancelable,
                                 @NonNull DlgButton mPositiveButton,
                                 @NonNull DlgButton mNegativeButton,
                                 int mAnimationResId,
    ...
    /**
     * Builder for {@link BottomsheetRateDlg}.
     */
    public static class Builder {
        ...
        private DlgButton positiveButton;
        private DlgButton negativeButton;
        ...
        public Builder setPositiveButton(@NonNull String name, int icon, @NonNull OnClickListener onClickListener) {
            positiveButton = new DlgButton(name, icon, onClickListener);
            return this;
        }
        ...
        public Builder setNegativeButton(@NonNull String name, int icon, @NonNull OnClickListener onClickListener) {
            negativeButton = new DlgButton(name, icon, onClickListener);
            return this;
        }
        ...
        /**
         * Build the {@link BottomsheetRateDlg}.
         */
        @NonNull
        public BottomsheetRateDlg build() {
            return new BottomsheetRateDlg(activity, title, message, isCancelable, positiveButton, negativeButton, animationResId, animationFile);
        }
    }
