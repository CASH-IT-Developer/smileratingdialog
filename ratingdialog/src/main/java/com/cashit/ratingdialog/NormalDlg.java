 ...
 */
public class NormalDlg extends AbstractDlg {


    protected NormalDlg(@NonNull Activity mActivity,
    ...
    public static class Builder {
        ...
        /**
         * Build the {@link NormalDlg}.
         */
        @NonNull
        public NormalDlg build() {
            return new NormalDlg(activity, title, message, isCancelable, positiveButton, negativeButton, animationResId, animationFile);
        }
    }
}
